...
def load() -> Config:
    ...
    return Config(
        ...
        mqtt_broker=env("MQTT_BROKER_URL", "tcp://175.155.35.79:1884"),
        ...
        media_service_url=env("MEDIA_SERVICE_URL", "http://175.155.35.79:8088"),
...
def devices(robot_id: str) -> list[Device]:
    ...
    result = [
        ...
        Device(
            ...
            control_status="idle",
            enabled=True,
            actions=["set_volume", "set_mute"],
            status={"volume": 50, "volumePercent": 50, "muted": False},
    ...
    result.extend([
        ...
        Device(
            ...
            status={"enabled": False, "powerOn": False, "mode": 0, "online": True},
            control_profile={
                "lightId": "light-001",
