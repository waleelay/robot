var WebRtcStreamer = (function() {
  ...
  WebRtcStreamer.prototype.connect = function(videourl, audiourl, options, localstream) {
    ...
    if (!this.iceServers) {
      ...
      fetch(this.srvurl + "/getIceServers")
  ...
  WebRtcStreamer.prototype.disconnect = function() {
    ...
    if (this.pc) {
      fetch(this.srvurl + "/hangup?peerid=" + this.pc.peerid)
        .then(this._handleHttpErrors)
  ...
  */
  WebRtcStreamer.prototype.onReceiveGetIceServers = function(iceServers, videourl, audiourl, options, stream) {
    ...
    try {
      ...
      var callurl = this.srvurl + "/call?peerid=" + this.pc.peerid + "&url=" + encodeURIComponent(videourl);
      if (audiourl) {
  ...
  WebRtcStreamer.prototype.getIceCandidate = function() {
    fetch(this.srvurl + "/getIceCandidate?peerid=" + this.pc.peerid)
      .then(this._handleHttpErrors)
      .then( (response) => (response.json()) )
