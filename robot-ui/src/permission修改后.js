...
const whiteList = ['/login', '/register','/bigScreen','/images/1.jpg', '/bigScreen/default', '/bigScreen/shouye', '/bigScreen/xlxc', '/bigScreen/rygk', '/bigScreen/cljg']
