export const ROBOT_TYPE_INFO = {
  ...
  'WHEELED_ROBOT': { width: 60, height: 57.3, bigImg: 'car.png', img: 'robot_car', icon: 'robot-car' },
  轮式机器人: { width: 60, height: 57.3, bigImg: 'car.png', img: 'robot_car', icon: 'robot-car' },
  ...
  // 备用
  四足机器狗: { width: 60, height: 41, bigImg: 'dog.png', img: 'robot_dog', icon: 'robot-dog' },
  四足机器人: { width: 60, height: 41, bigImg: 'dog.png', img: 'robot_dog', icon: 'robot-dog' },
