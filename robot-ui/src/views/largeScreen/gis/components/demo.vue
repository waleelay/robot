  ...
  export default {
    ...
    data() {
      return {
        ...
        pointB: { lat: 30.745482638228058, lng: 106.04 },
        pointAMarker: null,
        pointBMarker: null,
        movementPath: null,
        pathPoints: [],
    ...
    methods: {
      ...
      initPoints() {
        ...
        this.movementPath = L.polyline(this.pathPoints, {
          // color: '#e74c3c',
          fillColor:
            "linear-gradient(180deg, rgba(1, 144, 244, 0) 0%, rgba(11, 163, 245, 1) 5.51%, rgba(4, 23, 62, 0.16) 51.52%, rgba(50, 237, 250, 1) 82.62%, rgba(17, 176, 246, 1) 82.62%, rgba(7, 156, 245, 0) 100.03%)",
          weight: 6,
          // opacity: 0.6,
      ...
      resetPoints() {
        ...
        this.pointB = { lat: 30.748, lng: 106.04 };
