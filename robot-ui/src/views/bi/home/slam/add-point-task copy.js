...
export default {
  ...
  methods: {
    ...
    onCanvasClick(event) {
      ...
      // console.log(x, y, event.clientX, event.clientY, rect.left, rect.top, pixel, point);
      // console.log(111, this.img, this.drawablePoints);
