<template>
  <PlanEdit
    ...
    :id="currentId"
    :mode="mode"
    class="business2-content ml10 flex1 h100"
    @close="backToList"
    @saved="handleSaved"
  />
  <div v-else class="business2-content ml10 flex1 h100">
    <div class="business2-toolbar">
      ...
      <div class="business2-actions">
        ...
        <el-button type="primary" plain style="color: #17D1FF" @click="loadRows(1)">
          查询
        </el-button>
    ...
    <div class="business2-table">
      <el-table v-loading="loading" :data="rows" style="width: 100%">
        ...
        <el-table-column label="执行状态" width="110" align="center">
          <template slot-scope="{ row }">
            <span class="status" :class="executionStatusType(row.executionStatus)">
