 ...
 * @LastEditTime: 2026-04-17 14:05:52
 * @Description: 
 * @FilePath: \qihang-eiop-ui\src\views\bi\demo\components\modal\warning\WarningExecuteNo.vue
 * @Version: 
-->
<template>
  <el-dialog
...
export default {
  ...
  methods: {
    ...
    executeWarning(type) {
      ...
      this.loading = true
      setErrorisDeal({ ErrorId: this.ErrorId, IsDeal: type }).then(res => {
        if (res.code === 200) {
