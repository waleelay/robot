<!--
 * @Author: dengxumei
 * @Date: 2026-04-17 13:48:34
 * @LastEditors: dengxumei
 * @LastEditTime: 2026-04-17 15:10:35
 * @Description: 
 * @FilePath: \qihang-eiop-ui\src\views\bi\demo\components\Control.vue
 * @Version: 
-->
<template>
  <div class="flx-center">
    ...
    <div class="control-btns ml20">
      <div class="btn-box flx-justify-between flex-column wp310">
        <el-button type="primary" @click="controlRobot('startup')">退出充电桩</el-button>
        ...
        <div class="flx-justify-between mt10 w100">
          ...
          <el-button :disabled="deviceData.onDockState === '1'" type="primary" class="wp100" @click="handleControl(btnObj['jiting'].value)">急停</el-button>
          <el-select
