<template>
  <!-- <el-dialog
    ...
    title="异常报告"
  > -->
    <div class="flex popver-warning-info">
        ...
        <div class="box">
          <div class="top m4 flx-justify-between">
            <div class="flx-align-center">
              ...
              <div class="status ml10 success">业务告警 </div>
            </div>
                  ...
                  <div class="mt10" style="width: 640px; height: 355px; border: 0.5px solid #1665A2; background: #001D46;">
                    <el-carousel trigger="click" :autoplay="false" height="100%" ref="carouselRef" @change="handleChangeCarousel">
                      <el-carousel-item v-for="item in options" :key="item.key" :name="item.key">
                        <img v-if="item.url" :src="getImageSrc(item.url)" alt="">
...
export default {
  ...
  methods: {
    ...
    executeWarning(type) {
      ...
      this.loading = true
      setErrorisDeal({ ErrorId: this.details.ErrorId, IsDeal: type }).then(res => {
        if (res.code === 200) {
...
@import "./scss/warning-info-s.scss";
