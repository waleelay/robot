  ...
  <div class="middle_left">
    ...
    <div class="call_progress">
      <div class="progress-title">
        ...
        <span class="title_font"> 点名进度</span>
      </div>
      <div class="num-info">
<!--        任务点数以及剩余时间-->
        <div class="number">
...
<!--        那两个框-->
        <div class="num-icon">
          <div class="icon-item">
            <div class="cricle">{{unarrivedNum}}</div>
            <div class="icon-font">未到</div>
          </div>
          <div class="icon-item">
            <div class="cricle">{{arrivedNum}}</div>
            <div class="icon-font">已到</div>
          </div>
        </div>
      </div>
    </div>
    <div class="notnamed_list">
      <div class="list_title">
        <span class="decorate">|</span>
        <span class="title_font"> 点名监控</span>
      </div>
      <div class="list_table">
        <div v-if="showInfo" class="info-card">
          <img :src="getImageSrc(personInfo.pictureData)" alt="个人信息图片" class="info-image" />
          <div class="info-details">
            <p><strong>姓名：</strong> {{ personInfo.userName }}</p>
            <p><strong>点位名称：</strong> {{ personInfo.pointName }}</p>
            <p><strong>负责机器：</strong> {{ personInfo.dogName }}</p>
            <p><strong>点名结果：</strong> {{ personInfo.result }}</p>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      processNum: state => state.bigScreen.processNum !== null?state.bigScreen.processNum : 0 ,
