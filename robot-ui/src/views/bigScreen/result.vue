  ...
  <div class="bottom_centre">
    <div class="item">
      <div class="result-title">
        ...
        <span class="title_font"> 各时间段点名 </span>
        <el-date-picker
...
<!--      第一个表-->
    ...
    <div class="item">
      <div class="result-title">
        <span class="decorate">|</span>
        <span class="title_font"> 整体点名统计 </span>
        <el-date-picker
        ...
        <div class="result-info">
          <div class="info-item">
            ...
            <div class="arrive-text">
              <div class="font">未到人数</div>
              <div class="font"><span class="arrive-num">{{unarriveNum}}</span>人</div>
            </div>
          </div>
          <div class="info-item">
            <div class="arrive-img">
            ...
            <div class="arrive-text">
              <div class="font">已到人数</div>
              <div class="font"><span class="arrive-num">{{arriveNum}}</span>人</div>
            </div>
          </div>
        </div>
      </div>
...
import {getBarDate,getPieDate } from "../../api/bigScreen";
...
export default {
  ...
  methods: {
    ...
    setDefaultDateRange() {
      ...
      dayBeforeYesterday.setDate(now.getDate() - 7);
      dayBeforeYesterday.setHours(0, 0, 0, 0); // 前天的00:00
    ...
    getValue1Info() {
      const query ={StartTime: this.changeDate(this.value1[0]),EndTime: this.changeDate(this.value1[1])}
      getBarDate(query).then(res => {
        // console.log(res.data[0].ArrivedNum)
        let noNamedMax = 0
        let namedMax = 0
        if (res.data[0].ArrivedNum.length !== 0) {
          noNamedMax = this.getNextHundred(res.data[0].unArrivedNum)
          namedMax = this.getNextHundred(res.data[0].ArrivedNum)
        } else {
          noNamedMax = 0
          namedMax = 0
        }
          ...
          series: [
            {
              ...
              yAxisIndex:0,
              type: 'bar',
              data:this.replaceNullWithZero(res.data[0].unArrivedNum) ,
            ...
            },
            {
              ...
              yAxisIndex:1,
              type: 'bar',
              data: this.replaceNullWithZero(res.data[0].ArrivedNum) ,
              // data: [5,45,1,10,79,1,2,3,4,5,8,9,22,44],
              itemStyle: {
                color: "rgba(130,231,236,1)"
              }
    ...
    handleValue2Change() {
      ...
      const query ={StartTime: this.changeDate(this.value2[0]),EndTime: this.changeDate(this.value2[1])}
      // console.log(query)
      getPieDate(query).then(res => {
        // console.log(res)
