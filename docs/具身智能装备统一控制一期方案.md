...
| 字段 | 类型 | 必填 | 说明 |
|---|---|---:|---|
| `safetyOn` | boolean | 是 | true 打开安全开关，false 关闭 |
| `waitStatus` | boolean | 否 | 设置后是否等待/查询最新状态，默认 `true` |
...
```jsonc
{
  ...
  "params": {
    "safetyOn": true,                            // true 打开，false 关闭
    "waitStatus": true                           // 设置后等待/查询最新状态
  },
  "client": {
...
```jsonc
{
  ...
  "params": {
    "safetyOn": true,                            // 打开安全开关
    "waitStatus": true                           // 设置后等待状态
  },
