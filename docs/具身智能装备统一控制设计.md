...
| 文档 | 用途 |
|---|---|
| [具身智能装备统一控制一期方案](具身智能装备统一控制一期方案.md) | 一期实现范围，覆盖设备注册绑定、控制权、本体/云台遥控、捕网器、急停、WebSocket、MQTT |
| [具身智能装备统一控制二期方案](具身智能装备统一控制二期方案.md) | 二期扩展范围，覆盖机械臂、激光雷达、任务接管、driver 插件化、协议版本和审计回放 |
