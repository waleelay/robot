...
```text
recordings/org001/test001/camera01/2026/05/27/rec_9f8e/original/source.mp4
recordings/org001/test001/camera01/2026/05/27/rec_9f8e/hls/index.m3u8
```
...
```http
GET /api/control/recordings?robotId=test001&deviceId=camera01&status=READY&from=2026-05-27T00:00:00Z&to=2026-05-28T00:00:00Z&page=0&size=20
```

```http
GET /internal/media/recordings?robotId=test001&deviceId=camera01&status=READY&from=2026-05-27T00:00:00Z&to=2026-05-28T00:00:00Z&page=0&size=20
```
