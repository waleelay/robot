...
| `payload.safety_switch` | `PAYLOAD/net` | 上装安全开关 |
...
```json
{
  ...
  "devices": [
    ...
    },
    {
      ...
      "bindingId": "bind-robot-deep-001-net-launcher-001",
      "scope": "PAYLOAD",
...
| 动作 | 风险点 | 策略 |
|---|---|---|
| `payload.fire` | 捕网器发射 | 强独占、二次确认、安全开关、冷却、审计 |
