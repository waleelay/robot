...
def build():
    ...
    code(
        ...
        [
            ...
            '  "roomName": "media.test001.gimbal-001.visible",',
            '  "viewerToken": "jwt",',
    ...
    code(
        ...
        [
            ...
            '  "roomName": "media.test001.gimbal-001.visible",',
            '  "publisherToken": "jwt",',
            '  "publishIdentity": "robot:test001:gimbal-001",',
            '  "expiresAt": "2026-05-18T10:30:00+08:00"',
            "}",
        ],
    )
    ...
    table(
        ...
        ["对象", "规则", "示例"],
        [
            ["Room", "media.{robotId}.{deviceId}.{channel}", "media.test001.gimbal-001.visible"],
            ["机器人 Participant", "robot:{robotId}:{deviceId}", "robot:test001:gimbal-001"],
