...
public class PanoramaMockService {
    ...
    private List<Map<String, Object>> devices() {
        return List.of(
                device(
                        ...
                        "空闲中",
                        "idle",
                        taskSummary("task-001", "A区-夜间巡逻", "running", "20:00-22:00")),
                device(
                        "robot-002",
    ...
    private List<Map<String, Object>> taskItems() {
        return List.of(
                ...
                task(
                        ...
                        "2026-06-12 11:30:00",
                        "A区仓库",
                        List.of(equipment("robot-003", "巡检机器人一号", "HUMANOID_ROBOT", "fault"))),
                task(
                        "task-003",
                        "南侧围栏巡查",
                        "pending",
    ...
    private List<Map<String, Object>> cameras(String robotId, String typeCode) {
        ...
        return List.of(camera(cameraId, "前向双光云台"));
    }

    private Map<String, Object> camera(String cameraId, String name) {
        return Map.of(
                "cameraId", cameraId,
                "deviceId", cameraId,
                "name", name,
